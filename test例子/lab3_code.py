...
# First, define a constructor for class Bank that accepts as input a name for the bank, a reference to the currency of the bank (HINT: it is one of the clases you implemented above) and an initial value the bank holds. The default for the initial value should be 0.
